...
#
get_filename_component(filename "C:/Users/wuxianggujun/CodeSpace/CMakeProjects/TinaToolBox/dependencies/corrosion/corrosion-master.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/wuxianggujun/CodeSpace/CMakeProjects/TinaToolBox/cmake-build-debug/_deps/corrosion-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-corrosion-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-corrosion-populate${i}")
